...
/*                                             Tests                                             */
/*************************************************************************************************/
ZTEST(modem_backend_tty_suite, receive_ready_event_not_raised)
{
	bool result;
...
ZTEST(modem_backend_tty_suite, receive_ready_event_raised)
{
	int ret;
	bool result;
...
ZTEST(modem_backend_tty_suite, receive)
{
	int ret;
...
ZTEST(modem_backend_tty_suite, transmit)
{
	int ret;
